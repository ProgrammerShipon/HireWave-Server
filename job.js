const data = [
  ...
  },
  {
    ...
    jobType: "part time",
    salary: "450-900",
    closingDate: "2023-09-12",
    experience: ["Entry Level"],
    quantity: "3",
    applied: "23",
    overview:
      "Join VerbalCraft as a Content Writer and create compelling and engaging written content for various platforms. Enhance your writing skills while contributing to our content marketing efforts.",
    requirements: [
    ...
    skillsExperience: [
      "Experience in blog writing or content creation.",
    ...
    benefits: [
      ...
      "Regular feedback and guidance from experienced editors.",
    ],
    skills: ["Content Writing", "Research", "SEO", "Time Management"],
    status: "pending",
    open: true,
  },
  {
    ...
    jobType: "full time",
    salary: "700-1000",
    closingDate: "2023-09-14",
    experience: ["Mid Level"],
    quantity: "1",
    applied: "37",
    overview:
      "Join TechSolutions as a Software Engineer and be part of our dynamic team developing innovative software solutions. Contribute to the design, development, and testing of cutting-edge applications.",
    requirements: [
    ...
    skills: ["Java", "Python", "Agile Development", "Problem-Solving"],
    status: "pending",
    open: true,
  },
];